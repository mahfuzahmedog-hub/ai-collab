      ...
      {agents.length === 0 ? (
        <div className="flex items-center justify-center h-64 text-dark-500">
          <div className="text-center">
            ...
            <p className="text-sm text-dark-400">The Boss Agent will create team members when you submit a project.</p>
          </div>
        </div>
      ) : (
        <div className="space-y-6">
          {boss && (
            <div>
              <div className="flex items-center gap-2 mb-3">
                <h2 className="text-lg font-bold text-yellow-400">Engineering Manager</h2>
          ...
          <div>
            ...
            {workers.length === 0 ? (
              <p className="text-sm text-dark-500 py-8 text-center">No team members yet. The Boss Agent will build a team for your project.</p>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                {workers.map((agent) => (
